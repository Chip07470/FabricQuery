...
class HadoopDialog extends React.Component {
    constructor (props) {
        super(props);
...
export default withStyles(styles) (connect (mapStateToProps, mapDispatchToProps)(HadoopDialog));